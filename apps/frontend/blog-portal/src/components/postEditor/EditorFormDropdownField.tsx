              ...
              <Popover >
                <PopoverTrigger asChild>
                  <FormControl>
                    ...
                    >
                      {field.value
                        ? toFirstLetterUppercase(categories.find(
                ...
                <PopoverContent className="w-[200px] p-0 bg-white text-black flex flex-col items-center">
                  <Command className="flex flex-col gap-2 w-full">
                    <CommandInput className="bg-white text-black border-gray-100 border-[1px] rounded-sm p-1" placeholder="Search category..." />
